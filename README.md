...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create billboards-tn-app-3430
  fly apps create billboards-tn-app-3430-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app billboards-tn-app-3430
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app billboards-tn-app-3430-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'billboards-tn-app-3430-staging' does not match app name in config file 'billboards-tn-app-3430'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name billboards-tn-app-3430-db
  fly postgres attach --app billboards-tn-app-3430 billboards-tn-app-3430-db

  fly postgres create --name billboards-tn-app-3430-staging-db
  fly postgres attach --app billboards-tn-app-3430-staging billboards-tn-app-3430-staging-db
  ```
